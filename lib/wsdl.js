  ...
  if (type) {
    ...
    if (typeElement && !(typeName in Primitives)) {
      ...
      if (!(typeName in definitions.descriptions.types)) {
        ...
        var elem;
        definitions.descriptions.types[typeName] = {};
        if (this.$ref) {
        ...
        // copy everything to elem reference
        if (definitions.descriptions.types[typeName]._circular) {
          Object.keys(elem).forEach(function (key) {
            definitions.descriptions.types[typeName][key] = elem[key];
          });
        }
        else {
        ...
        definitions.descriptions.types[typeName]._circular = true;
      }
